...
def main():
    ids = ["https://www.instagram.com/" + line.split("/")[-1] for line in open("D:/few projects/Anubhav Fellowhip/input.txt", newline='\n')]
    if len(ids) > 0:
        ...
        with open('D:/few projects/Anubhav Fellowhip/credentials/credentials_3.txt', 'r') as file:
